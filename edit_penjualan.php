...
$det=mysql_query("select * from penjualan where id='$id_brg'")or die(mysql_error());
while($d=mysql_fetch_array($det)){
	?>					
<form action="edit_penjualan_dt.php" method="post">
		<table class="table">
			<tr>
				<td></td>
			...
			<tr>
				<td>Tanggal</td>
				<td><input name="tanggal" type="text" class="form-control" id="tgl" autocomplete="off" value="<?php echo $d['tanggal'] ?>"></td>
			</tr>
                        <tr>
				<td>Nama Konsumen</td>
				<td><input type="text" class="form-control" name="nama_konsumen" value="<?php echo $d['nama_konsumen'] ?>"></td>
			</tr>
			<tr>
				<td>Nama</td>
				<td>
